...
~~For client registration for the instance run at https://bab.alexkar598.dev, see https://forms.gle/TY5AyaiuMYFZ272r8~~ The hosted service has been shutdown. You must now self host if you wish to continue using BAB.
...
5. Connect as postgres to the database (default address is 127.0.0.1:15432) and create a row in the Client table.
